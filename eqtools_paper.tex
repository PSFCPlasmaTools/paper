...
\bibitem{1} P.~Peterson,
  ...
  296--305.
\bibitem{2} J. D. Hunter, 9~(3) (2007) 90--95.
...
Most of the computational effort is expended in the Fortan spline routines provided by SciPy \cite{scipy,dierckxBook}, which means that the overhead contributed by the fact that Python is an interpreted language is minimal.
