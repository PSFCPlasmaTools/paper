...
\ead{markchil@mit.edu}

\author[PSFC]{I. C. Faust}
\ead{faustian@mit.edu}
...
\bibitem{1} P.~Peterson, {F2PY}: a tool for connecting {F}ortan and {P}ython programs,
  International Journal of Computational Science and Engineering 4~(4) (2009)
  296--305.
\bibitem{2} J. D. Hunter, Matplotlib: A 2{D} graphics environment, Computing in Science \& Engineering, 9~(3) (2007) 90--95.
\bibitem{3} J.~A. Stillerman, T.~W. Fredian, K.~A. Klare, G.~Manduchi, {MDSplus} data
  acquisition system, Review of Scientific Instruments 68~(1) (1997) 939--942.
\bibitem{4} S.~van der Walt, S. C. Colbert and G.~Varoquaux, The {N}um{P}y array: a structure for efficient numerical computation, Computing in Science \& Engineering 13~(2) (2011) 22--30.
