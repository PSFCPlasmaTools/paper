...
This inverse problem, as shown by equation 5, can be solved using any number of numerical methods.
...
The grid size in flux space must chosen to be larger than the length discretization size in order to properly resolve features in the plasma.
Shown in figure 5 is an example line of sight using the Soft X-ray tomography system on Alcator C-Mod.
